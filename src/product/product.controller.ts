import {Controller,Post,Body,Get,Patch,Param,Delete,ValidationPipe,} from '@nestjs/common';
...
export class ProductController {
    ...
    @Post('create')
    public async createProduct(@Body(ValidationPipe) createProductDto: CreateProductDTO,): Promise<Product> {
        //fef
